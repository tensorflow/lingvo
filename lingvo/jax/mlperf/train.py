...
def train_and_evaluate(model_name: str, job_log_dir: Optional[str],
  ...
  _, eval_p = mllogger.extract_mlperf_eval_pipeline(eval_input_p)
  mllogger.initialize(model_p, train_input_p, eval_p, max_train_steps,
                      target_accuracy)
...
def train_and_evaluate_spmd_model(model_p: InstantiableParams,
                                  train_input_p: InstantiableParams,
                                  job_log_dir: Optional[str],
