...
class LSTMCellSimple(RNNCell):
  ...
  def _CreateVariables(self):
    super(LSTMCellSimple, self)._CreateVariables()
    p = self.params
    # Define weights.
...
class LSTMCellSimpleDeterministic(LSTMCellSimple):
  ...
  def _CreateVariables(self):
    super(LSTMCellSimpleDeterministic, self)._CreateVariables()
    p = self.params
    self.CreateVariable(
...
class QuantizedLSTMCell(RNNCell):
  ...
  def _CreateVariables(self):
    super(QuantizedLSTMCell, self)._CreateVariables()
    p = self.params
...
class LayerNormalizedLSTMCell(RNNCell):
  ...
  def _CreateVariables(self):
    super(LayerNormalizedLSTMCell, self)._CreateVariables()
    p = self.params
...
class SRUCell(RNNCell):
  ...
  def _CreateVariables(self):
    super(SRUCell, self)._CreateVariables()
    p = self.params
    # Define weights.
    wm_pc = py_utils.WeightParams(
