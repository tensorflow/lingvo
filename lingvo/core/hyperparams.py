...
class Params:
  ...
  # TODO(b/225403281): This is a temporary function introduced for migration
  # purposes. You most likely don't want to use it. Must be removed once the
  # migration is complete.
  def ToTextAlternate(self, include_types: bool = False, separator: str = ':'):
    """Encodes params into a simple text format using an alternate way.
